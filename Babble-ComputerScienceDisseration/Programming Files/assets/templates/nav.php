...
$html = $html.'
<li>
   <a href="javascript:void(0)" class="submenu-toggle" style="height: 48px;">
      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24" height="24" viewBox="0 0 164 164">
      ...
      <span class="brand-name hidden-fold" style=" white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">'.$_SESSION["instName"].'</span>
   ...
   <ul class="submenu">
      ...
      <li>
         <a href="?page=logout">
            <i class="menu-icon zmdi zmdi-close-circle zmdi-hc-lg"></i>
...
<li class="menu-section-heading">Conversations</li>';
