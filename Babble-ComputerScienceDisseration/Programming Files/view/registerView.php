...
<header class="login-page-header d-flex">
  ...
  <div id="form-switch-btns" class="btn-group switch-btns">
    ...
    <a href ="?page=register"><button class="btn" disabled>Register</button></a>
  </div>
</header>
...
<div class="login-page-wrap">
  ...
  <div class="side second-side">
    <div class="side-content">
       <div class = "side-content text-center">
       <h4 class="my-5 font-weight-light">Sign Up!</h4>
       </div>
       ...
       <form id="signin-form" class="form" action="'.$action.'" method="POST">
          ...
          <div class="form-group">
             <input type="text" class="form-control" name="inst" placeholder="Institute" maxlength="30">
          </div>
          ...
          <input type="submit" class="btn btn-outline-success py-2 mt-5" style="width: 100%;" value="Sign up">
...
<!-- End Main Register Page Content -->
